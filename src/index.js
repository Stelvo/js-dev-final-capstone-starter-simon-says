...
const padContainer=document.querySelector(".js-heading"); // Use querySelector() to get the heading element
/**
* VARIABLES
*/
...
startButton.addEventListener("click",activatePad("red"));//startButtonHandler);
/**
* EVENT HANDLERS
*/
